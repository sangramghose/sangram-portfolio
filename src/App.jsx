...
const Hero = () => {
  ...
  return (
    <section id="home" className="hero">
      <div className="bento">
        <div className="tile tile-glow reveal span-8" style={{ padding: '42px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        ...
        <div className="tile reveal span-4 portrait">
        ...
        <div className="tile reveal span-3" style={{ padding: '24px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
        ...
        <div className="tile reveal span-3" style={{ padding: '24px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', background: 'var(--elevated)', borderColor: 'var(--border-strong)' }}>
          <div className="metric-label">Metric</div>
          <div>
        ...
        <div className="tile reveal span-12" style={{ padding: '16px' }}>
  ...
  <section id="highlights">
    ...
    <div className="bento" style={{ marginTop: '28px' }}>
      {DATA.highlights.map((h, i) => (
        <div key={i} className={`tile reveal ${h.span}`} style={{ padding: '28px', display: 'flex', flexDirection: 'column' }}>
...
const About = () => (
  <section id="about">
    ...
    <div className="sec-rule"></div>
    <div className="bento" style={{ marginTop: '28px' }}>
      <div className="tile reveal span-7" style={{ padding: '34px' }}>
      ...
      <div className="tile reveal span-5" style={{ padding: '34px' }}>
      ...
      <div className="tile reveal span-12" style={{ padding: '24px 34px', display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between', gap: '16px', background: 'var(--elevated)', borderColor: 'var(--border-strong)' }}>
        <div>
...
const Skills = () => (
  <section id="skills">
    ...
    <div className="bento" style={{ marginTop: '28px' }}>
      {DATA.skills.map((s, i) => (
        <div key={i} className={`tile reveal ${s.span}`} style={{ padding: '28px' }}>
...
const Experience = () => (
  <section id="experience">
    ...
    <div className="bento" style={{ marginTop: '28px' }}>
      {DATA.exp.map((e, i) => (
        <div key={i} className={`tile reveal ${e.full ? 'span-12' : 'span-6'}`} style={{ padding: '28px' }}>
    ...
    <div style={{ marginTop: '28px', display: 'grid', gap: '16px' }}>
      {DATA.proj.map((p, i) => (
        <div key={i} className="bento">
          <div className="tile tile-glow reveal span-5" style={{ padding: '34px', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
            <div>
          ...
          <div className="reveal span-7" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
            {p.features.map(([title, body], idx) => (
              <div key={idx} className="tile" style={{ padding: '20px' }}>
          ...
          {p.preview && (
            <div className="tile reveal span-12 project-preview" style={{ padding: '0' }}>
              <img src={`/${p.preview}`} alt={`${p.title} project preview`} loading="lazy" onError={(e) => e.target.closest('.project-preview').remove()} />
            </div>
          )}
          <div className="tile reveal span-12" style={{ padding: '20px 28px', display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
...
const Education = () => (
  <section id="education">
    ...
    <div className="sec-rule"></div>
    <div className="bento" style={{ marginTop: '28px' }}>
      <div className="tile reveal span-8" style={{ padding: '34px', display: 'flex', flexWrap: 'wrap', gap: '20px', alignItems: 'flex-start' }}>
      ...
      <div className="tile reveal span-4" style={{ padding: '34px', background: 'var(--elevated)', borderColor: 'var(--border-strong)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
...
const Certifications = () => (
  <section id="certifications">
    ...
    <div className="bento" style={{ marginTop: '28px' }}>
      {DATA.cert.map((c, i) => (
        <a key={i} className={`tile tile-link reveal ${c.span}`} href={c.href} target="_blank" rel="noopener" style={{ padding: '24px' }}>
...
const Contact = () => (
  <section id="contact" style={{ paddingBottom: '100px' }}>
    ...
    <div className="sec-rule"></div>
    <div className="bento" style={{ marginTop: '28px' }}>
      <div className="tile reveal span-12" style={{ padding: '34px', display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between', gap: '20px', background: 'var(--primary)', borderColor: 'var(--primary)', color: '#fff' }}>
        <div>
      ...
      <a className="tile reveal span-3" style={{ padding: '26px', display: 'flex', flexDirection: 'column', minHeight: '148px' }} href="mailto:sangramkesharighose@gmail.com">
      ...
      <a className="tile reveal span-3" style={{ padding: '26px', display: 'flex', flexDirection: 'column', minHeight: '148px' }} href="tel:+918456841232">
        <div className="contact-icon">
      ...
      <a className="tile reveal span-3" style={{ padding: '26px', display: 'flex', flexDirection: 'column', minHeight: '148px' }} href="https://github.com/sangramghose" target="_blank" rel="noopener">
        <div className="contact-icon">
      ...
      <a className="tile reveal span-3" style={{ padding: '26px', display: 'flex', flexDirection: 'column', minHeight: '148px' }} href="https://www.linkedin.com/in/sangramghose/" target="_blank" rel="noopener">
        <div className="contact-icon">
